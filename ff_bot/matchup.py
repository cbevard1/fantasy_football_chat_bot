...
class Opponent(object):
    def __init__(self, id, score, projected_score, bench_score, bench_projected_score, min_remaining, min_total):
        self.team_id = id
        self.score = score
...
class Matchup(object):
    ...
    async def load_matchup(self, soup):
        ...
        self.opp1 = Opponent(team1_id, team1_pts, team1_proj_pts, team1_bench_pts, team1_bench_proj_pts, team1_time_remaining, team1_time_total)
        self.opp2 = Opponent(team2_id, team2_pts, team2_proj_pts, team2_bench_pts, team2_bench_proj_pts, team2_time_remaining, team2_time_total)
